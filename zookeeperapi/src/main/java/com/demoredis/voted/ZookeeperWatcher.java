...
/**
 * Created by huangjinlong7 on 2017/8/25.
 */
public class ZookeeperWatcher implements Watcher {
    ...
    /** zookeeper服务器地址 */
    private static final String CONNECTION_ADDR = "10.33.42.51:2182,10.33.42.52:2182,10.33.42.57:2182";
    /** zk父路径设置 */
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (zkWatch.createPath(PARENT_PATH, System.currentTimeMillis() + "")) {
          ...
          //  zkWatch.readData(PARENT_PATH, true);
            zkWatch.writeData(PARENT_PATH, "modify data");
